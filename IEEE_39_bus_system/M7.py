...
def preprocess(mpc, data_dir, all_data=False):
    ...
    if all_data:
        ...
        input_pq_Bdiag[25000:29000, :], output_cut[25000:29000, :, 0]), input_Pd_orginal[:20000, :,
...
if __name__ == '__main__':
    ...
    res = model(eval_data[0])

    output_cut = res.detach().cpu().numpy() * input_Pd_original_eval
    ...
    output_cut_eval = eval_data[1].detach().cpu().numpy() * input_Pd_original_eval
